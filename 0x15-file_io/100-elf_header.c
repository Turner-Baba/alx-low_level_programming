...
/**
 * magic_print - outputs the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
void magic_print(unsigned char *e_ident)
{
	...
	for (str = 0; str < EI_NIDENT; str++)
	{
		printf("%02x", e_ident[str]);
...
/**
 * class_print - outputs the class of an ELF header.
...
/**
 * data_print - outputs the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void data_print(unsigned char *e_ident)
{
...
/**
 * version_print - outputs the version of an ELF header.
...
/**
 * osabi_print - outputs the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void osabi_print(unsigned char *e_ident)
{
...
/**
 * abi_print - outputs the ABI version of an ELF header.
...
/**
 * type_print - outputs the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void type_print(unsigned int e_type, unsigned char *e_ident)
...
/**
 * entry_print - outputs the entry point of an ELF header.

...
void diaplay_magic(unsigned char *e_ident);
...
/**
 * display_elf - a function that checks if a file is an ELF file.
...
/**
 * display_magic - a function that prints the magic numbers of an ELF header.
 * @e_ident: pointer to an array containing the ELF magic numbers.
 *
...
/**
 * display_class - a function that prints the class of an ELF header.
...
/**
 * display_data - a function that prints the data of an ELF header.
...
/**
 * display_version - a function that displays the version of an ELF header.
...
/**
 * display_osabi - a function that displays the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void display_osabi(unsigned char *e_ident)
{
...
/**
 * display_abi - a function that displays the ABI version of an ELF header.
...
/**
 * display_type - a function that displays the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void display_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * display_entry - a function that displays the entry point of an ELF header.
